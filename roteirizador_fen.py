...
def puxar_sequencias_hoteis():
    ...
    lista_abas = ['Hoteis Noronha']

    lista_df_hoteis = ['df_noronha']
...
def identificar_apoios_em_df(df_servicos):
    ...
    for n_roteiro in df_servicos['Roteiro'].unique().tolist():
        ...
        for veiculo in df_ref['Carros'].unique().tolist():
            ...
            if pax_carro>4 and pax_carro<=15 and limitacao_van:
            ...
            elif pax_carro>15 and pax_carro<=27 and limitacao_micro:
            ...
            elif pax_carro>27 and limitacao_bus:
            ...
            for index in range(len(df_ref_5)):
                ...
                if index==0:
                    ...
                    if df_ref_5.at[index, 'Apoios']=='':
                        ...
                        if paxs_total_apoio+paxs_hotel<=15:
                    ...
                    if df_ref_5.at[index, 'Apoios']=='':
                        ...
                        if verificador_n_hoteis<=max_hoteis and paxs_total_apoio+paxs_hotel<=15:
...
def verificar_rotas_alternativas_ou_plotar_roteiros(df_roteiros_alternativos, row_warning, row3, coluna, df_hoteis_pax_max, df_router_filtrado_2, df_roteiros_apoios, 
...
if not 'df_user' in st.session_state:
    ...
    st.session_state.df_user = getUser(st.query_params["userId"], 'test_phoenix_noronha')
...
if roteirizar:
    ...
    verificar_rotas_alternativas_ou_plotar_roteiros(df_roteiros_alternativos, row_warning, row3, coluna, df_hoteis_pax_max, df_router_filtrado_2, df_roteiros_apoios, 
